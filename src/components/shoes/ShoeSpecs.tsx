  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div className="bg-white/5 rounded-3xl p-8">
        <h3 className="text-xl font-bold text-white mb-6">성능 지표</h3>
        <div className="h-80">
        ...
        <div className="grid grid-cols-2 gap-3 mt-6">
          {chartData.map((item) => (
            ...
            >
              ...
              <span className="text-sm font-semibold text-white">{item.value}/10</span>
            </div>
          ))}
        </div>
      </div>
      ...
      {/* Specs Table */}
      <div className="bg-white/5 rounded-3xl p-8">
        <h3 className="text-xl font-bold text-white mb-6">상세 스펙</h3>
        ...
        {/* Score Bars */}
        <div className="mt-8">
          <h4 className="text-lg font-semibold text-white mb-4">점수 분석</h4>
